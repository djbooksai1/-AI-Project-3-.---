...
export function GoogleIcon() {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" className="h-5 w-5 mr-3">
            ...
            <path fill="#34A853" d="M24 48c6.21 0 11.48-2.08 15.3-5.54l-7.73-6c-2.08 1.4-4.73 2.23-7.57 2.23-5.27 0-9.84-3.58-11.45-8.43l-7.98 6.19C6.51 42.62 14.62 48 24 48z"/>
        </svg>
    );
}
