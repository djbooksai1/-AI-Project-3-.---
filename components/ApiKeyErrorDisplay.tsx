...
export const ApiKeyErrorDisplay = ({ message }: { message: string }) => {
    return (
        <div className="bg-danger/20 border border-danger text-danger p-6 rounded-lg mb-6 shadow-md">
            <strong className="font-bold text-lg block mb-2">해적 AI 이미지 분석 API 설정 오류</strong>
            ...
            <div className="mt-4 text-sm bg-background/50 p-4 rounded-md text-text-primary">
                ...
                <ol className="list-decimal list-inside mt-2 space-y-2">
                    ...
                    <li>'API 및 서비스' > '라이브러리'에서 <strong>이미지 분석(텍스트 인식) API</strong>(Cloud Vision API)를 검색하여 '사용 설정'했는지 확인하세요.</li>
                    <li>'API 및 서비스' > '사용자 인증 정보'에서 사용 중인 API 키가 <strong>이미지 분석(텍스트 인식) API</strong>를 사용하도록 제한되지 않았는지 확인하세요.</li>
